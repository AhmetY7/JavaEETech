				...
				<%
					...
					for (int i = 0; i < listUsers.size(); i++) {
						...
						deleteURL = request.getContextPath() + "/operation?page=deleteUser" + "&usersId="
								+ listUsers.get(i).getUsers_id(); // Delete için url oluşturduk
						out.print("<td><a href=" + updateURL + ">Update</a>|");
				%>
				<a href="<%=deleteURL%>" onclick="if(!confirm('Are you sure to delete the user?')) return false">Delete</a> <%-- delete linki oluşturduk --%>
				</td>
				</tr>
				<%
					}
